...
\textcolor{red}{Amid growth, two informational ingredianets remain as sampling times and pathogen genomes. Central idea is that evolutionary differences occur at some rate informative about epi dynamics}
\textcolor{red}{However, sampling times pose a risk where it is possible to identify patients. In one case - Washington. Another study found, it is frequently easy to track patients, suggested release of data is on a case-by case basis}
